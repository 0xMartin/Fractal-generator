...
public class Julius implements Fractal {
     ...
     */
    public Julius(int iterations, Range Real, Range Imaginar, Dimension size) {
    ...
    private class SubThread implements Runnable {
        ...
        public void run() {
            ...
            renderFractal(g2, this.it, this.re, this.im, this.size, this.Re, this.Im);
            this.status = 100;
        }

        public void renderFractal(Graphics2D graphics, int iterations, Range Real, Range Imaginar, Dimension size, double re, double im) {
            //create color palete
